...
class SettingCard(QFrame):
    ...
    def __init__(self, title, description=None, parent=None):
        ...
        if title:
            ...
            self.title_lbl.setStyleSheet("font-weight: bold; font-size: 16px; color: #0F172A; font-family: 'Manrope', sans-serif;")
            self.title_lbl.setObjectName("SettingCardTitle")
            self.header_layout.addWidget(self.title_lbl)
            
            if description:
                self.desc_lbl = QLabel(description)
                self.desc_lbl.setStyleSheet("color: #64748B; font-size: 13px; line-height: 18px; font-family: 'Inter', sans-serif;")
    ...
    def update_theme_style(self, theme):
        ...
        if theme == "dark":
            ...
            if hasattr(self, "title_lbl"):
                self.title_lbl.setStyleSheet("font-weight: bold; font-size: 16px; color: #F8FAFC; font-family: 'Inter', sans-serif;")
            if hasattr(self, "desc_lbl"):
                self.desc_lbl.setStyleSheet("color: #94A3B8; font-size: 13px; line-height: 18px; font-family: 'Inter', sans-serif;")
        else:
            self.setStyleSheet("""
                QFrame#SettingCardFrame {
